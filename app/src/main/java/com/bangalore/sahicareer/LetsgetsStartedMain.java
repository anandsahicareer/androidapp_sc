...
public class LetsgetsStartedMain extends AppCompatActivity implements View.OnClickListener{
    private DrawerLayout dl;
    private ActionBarDrawerToggle t;
    private NavigationView nv;
    LinearLayout ll_footer_home,ll_footer_callnow,ll_footer_contactus,ll_footer_plans,ll_footer_profile;

    LinearLayout ll_represent_school,ll_represent_college,ll_represent_company;

    Dialog dialog;
    String str_cnt_name,str_cnt_mobile,str_cnt_email,str_cnt_subject,str_cnt_message;
    private String TAG = LetsgetsStartedMain.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_letsgets_started_main);
        ...
        ll_represent_school=(LinearLayout) findViewById(R.id.needhelp_ll_represent_school);
        ll_represent_school.setOnClickListener(this);

        ll_represent_college=(LinearLayout) findViewById(R.id.needhelp_ll_represent_college);
        ll_represent_college.setOnClickListener(this);

        ll_represent_company=(LinearLayout) findViewById(R.id.needhelp_ll_represent_company);
        ll_represent_company.setOnClickListener(this);

        ll_footer_home=(LinearLayout)findViewById(R.id.needhelp_ll_footer_home);
        ll_footer_home.setOnClickListener(this);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.needhelp_ll_footer_callnow);
        ll_footer_callnow.setOnClickListener(this);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.needhelp_ll_footer_contactus);
        ll_footer_contactus.setOnClickListener(this);
        ll_footer_plans=(LinearLayout)findViewById(R.id.needhelp_ll_footer_plans);
        ll_footer_plans.setOnClickListener(this);
        ll_footer_profile=(LinearLayout)findViewById(R.id.needhelp_ll_footer_profile);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.nv_item_home:
                        Intent i = new Intent(LetsgetsStartedMain.this, MainActivity.class);
                        startActivity(i);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_assessment:
                        Intent j = new Intent(LetsgetsStartedMain.this, CareerAssessment.class);
                        startActivity(j);
                        dl.closeDrawers();
                        break;
                    case R.id.nv_item_counselling:
                        Intent k= new Intent(LetsgetsStartedMain.this, Career_counselling.class);
                        startActivity(k);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(LetsgetsStartedMain.this, Jobsandinternships.class);
                        startActivity(l);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent resume_service = new Intent(LetsgetsStartedMain.this, ResumeService.class);
                        startActivity(resume_service);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_learn_english:
                        Intent learn_english = new Intent(LetsgetsStartedMain.this, LearnEnglishPage.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.needhelp_ll_footer_home:
                Intent home = new Intent(LetsgetsStartedMain.this, MainActivity.class);
                startActivity(home);

                break;

            case R.id.needhelp_ll_footer_callnow:
                CallNowDialog callnowdialog = new CallNowDialog();
                callnowdialog.showDialog(LetsgetsStartedMain.this);
                break;

            case R.id.needhelp_ll_footer_contactus:
                ContactUsDialog contactUsDialog = new ContactUsDialog();
                contactUsDialog.showDialog(LetsgetsStartedMain.this);

                break;

            case R.id.needhelp_ll_footer_plans:
                Intent planpage = new Intent(LetsgetsStartedMain.this, MembershipPlanpage.class);
                startActivity(planpage);

                break;


            case R.id.needhelp_ll_footer_profile:
                Intent profilepage = new Intent(LetsgetsStartedMain.this, ProfilePage.class);
                startActivity(profilepage);

                break;

            case R.id.needhelp_ll_represent_school:

                v.startAnimation(buttonClick);
                Intent represent_school_college = new Intent(LetsgetsStartedMain.this, Represent_school.class);
                startActivity(represent_school_college);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.needhelp_ll_represent_college:

                v.startAnimation(buttonClick);
                Intent represent_college = new Intent(LetsgetsStartedMain.this, Represent_college.class);
                startActivity(represent_college);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.needhelp_ll_represent_company:

                v.startAnimation(buttonClick);
                Intent represent_company = new Intent(LetsgetsStartedMain.this, Represent_company.class);
                startActivity(represent_company);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;
            default:
                break;
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(LetsgetsStartedMain.this,R.layout.my_spinner_items,strarray_selectsubject);
                ...
                public void onClick(View v) {
                    ...
                    if(str_cnt_name.equals("")){
                        ...
                        if (Globalvariables.progressDialog == null) {
                            Globalvariables.progressDialog = Globalvariables.createProgressDialog(LetsgetsStartedMain.this);
