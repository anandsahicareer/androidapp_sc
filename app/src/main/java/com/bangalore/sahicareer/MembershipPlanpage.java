...
public class MembershipPlanpage extends AppCompatActivity implements View.OnClickListener{
    ...
    Button bt_free_plan_a,bt_free_plan_b,bt_rs499_a,bt_rs499_b,bt_rs999_a,bt_rs999_b,bt_rs1799_a,bt_rs1799_b;
    String ClickedPayableValue;

    private String TAG = MembershipPlanpage.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_membership_planpage);
        ...
        ll_footer_home=(LinearLayout)findViewById(R.id.mp_ll_footer_home);
        ll_footer_home.setOnClickListener(this);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.mp_ll_footer_callnow);
        ll_footer_callnow.setOnClickListener(this);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.mp_ll_footer_contactus);
        ll_footer_contactus.setOnClickListener(this);
        ll_footer_profile=(LinearLayout)findViewById(R.id.mp_ll_footer_profile);
        ll_footer_profile.setOnClickListener(this);
        bt_free_plan_a=(Button)findViewById(R.id.bt_mp_free_a);
        bt_free_plan_a.setOnClickListener(this);
        bt_free_plan_b=(Button)findViewById(R.id.bt_mp_free_b);
        bt_free_plan_b.setOnClickListener(this);

        bt_rs499_a=(Button)findViewById(R.id.btn_rs499_a);
        bt_rs499_a.setOnClickListener(this);

        bt_rs499_b=(Button)findViewById(R.id.btn_rs499_b);
        bt_rs499_b.setOnClickListener(this);

        bt_rs999_a=(Button)findViewById(R.id.btn_rs999_a);
        bt_rs999_a.setOnClickListener(this);

        bt_rs999_b=(Button)findViewById(R.id.btn_rs999_b);
        bt_rs999_b.setOnClickListener(this);

        bt_rs1799_a=(Button)findViewById(R.id.btn_rs1799_a);
        bt_rs1799_a.setOnClickListener(this);

        bt_rs1799_b=(Button)findViewById(R.id.btn_rs1799_b);
        bt_rs1799_b.setOnClickListener(this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.nv_item_home:
                        Intent i = new Intent(MembershipPlanpage.this, MainActivity.class);
                        startActivity(i);
                        break;

                    case R.id.nv_item_assessment:
                        Intent j = new Intent(MembershipPlanpage.this, CareerAssessment.class);
                        startActivity(j);
                        break;
                    case R.id.nv_item_counselling:
                        Intent k= new Intent(MembershipPlanpage.this, Career_counselling.class);
                        startActivity(k);
                        break;

                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(MembershipPlanpage.this, Jobsandinternships.class);
                        startActivity(l);
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent resume_service = new Intent(MembershipPlanpage.this, ResumeService.class);
                        startActivity(resume_service);
                        break;

                    case R.id.nv_item_learn_english:
                        Intent learn_english = new Intent(MembershipPlanpage.this, LearnEnglishPage.class);
...
*/
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mp_ll_footer_home:
                Intent home = new Intent(MembershipPlanpage.this, MainActivity.class);
                startActivity(home);

                break;

            case R.id.mp_ll_footer_callnow:
                CallNowDialog callnowdialog = new CallNowDialog();
                callnowdialog.showDialog(MembershipPlanpage.this);
                break;

            case R.id.mp_ll_footer_contactus:
                ContactUsDialog contactUsDialog = new ContactUsDialog();
                contactUsDialog.showDialog(MembershipPlanpage.this);
                break;

                case R.id.mp_ll_footer_profile:
                Intent profilepage = new Intent(MembershipPlanpage.this, ProfilePage.class);
                startActivity(profilepage);
                break;

            case R.id.bt_mp_free_a:
                new CheckFreePlanAPI().execute();
                break;
            case R.id.bt_mp_free_b:
                new CheckFreePlanAPI().execute();
                break;

            case R.id.btn_rs499_a:
                ClickedPayableValue="499";
                new CheckPayablePlanAPI().execute();
                break;
            case R.id.btn_rs499_b:
                ClickedPayableValue="499";
                new CheckPayablePlanAPI().execute();
                break;

            case R.id.btn_rs999_a:
                ClickedPayableValue="999";
                new CheckPayablePlanAPI().execute();
                break;
            case R.id.btn_rs999_b:
                ClickedPayableValue="999";
                new CheckPayablePlanAPI().execute();
                break;

            case R.id.btn_rs1799_a:
                ClickedPayableValue="1799";
                new CheckPayablePlanAPI().execute();
                break;

            case R.id.btn_rs1799_b:
                ClickedPayableValue="1799";
                new CheckPayablePlanAPI().execute();
                break;
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(MembershipPlanpage.this,R.layout.my_spinner_items,strarray_selectsubject);
                ...
                public void onClick(View v) {
                    ...
                    if(str_cnt_name.equals("")){
                       ...
                       /* if (progressDialog == null) {
                            progressDialog = Globalvariables.createProgressDialog(CareerAssessment.this);
                            progressDialog.show();
                        } else {
                            progressDialog.show();
                        }*/
    ...
    public class CheckFreePlanAPI extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("https://www.sahicareer.com/mobile/check-freeplandetails"); // here is your URL path
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(ack.equals("0")){
                    ...
                    Intent i = new Intent(MembershipPlanpage.this, Career_counselling.class);
                    startActivity(i);
                    Toast toast = Toast.makeText(getApplicationContext(), message, Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    TextView v1 = (TextView) toast.getView().findViewById(android.R.id.message);
                    ...
                    Intent i = new Intent(MembershipPlanpage.this, CareerAssessment.class);
                    startActivity(i);
                    Toast toast = Toast.makeText(getApplicationContext(), message, Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    TextView v1 = (TextView) toast.getView().findViewById(android.R.id.message);
    ...
    public class CheckPayablePlanAPI extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("https://www.sahicareer.com/mobile/check-purchased-plandetails"); // here is your URL path



                JSONObject postDataParams = new JSONObject();
                postDataParams.put("user_id", Globalvariables.user_id);
                if(ClickedPayableValue.equals("499")) {
                    postDataParams.put("plan_id", "6851");
                }
                if(ClickedPayableValue.equals("999")) {
                    postDataParams.put("plan_id", "6852");
                }
                if(ClickedPayableValue.equals("1799")) {
                    postDataParams.put("plan_id", "6853");
                }
                Log.e("params",postDataParams.toString());
