...
public class ResumeService extends AppCompatActivity implements View.OnClickListener{
    ...
    private String TAG = ResumeService.class.getSimpleName();
    LinearLayout ll_resume_enhancement,ll_resume_builder,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_footer_home=(LinearLayout)findViewById(R.id.rs_ll_footer_home);
        ll_footer_home.setOnClickListener(this);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.rs_ll_footer_callnow);
        ll_footer_callnow.setOnClickListener(this);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.rs_ll_footer_contactus);
        ll_footer_contactus.setOnClickListener(this);
        ll_footer_plans=(LinearLayout)findViewById(R.id.rs_ll_footer_plans);
        ll_footer_plans.setOnClickListener(this);
        ll_footer_profile=(LinearLayout)findViewById(R.id.rs_ll_footer_profile);
        ll_footer_profile.setOnClickListener(this);

        ll_resume_enhancement=(LinearLayout)findViewById(R.id.rs_ll_resume_enhancement);
        ll_resume_enhancement.setOnClickListener(this);

        ll_resume_builder=(LinearLayout)findViewById(R.id.rs_ll_resume_build);
        ll_resume_builder.setOnClickListener(this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.nv_item_home:
                        Intent i = new Intent(ResumeService.this, MainActivity.class);
                        startActivity(i);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_assessment:
                        Intent j = new Intent(ResumeService.this, CareerAssessment.class);
                        startActivity(j);
                        dl.closeDrawers();
                        break;
                    case R.id.nv_item_counselling:
                        Intent k= new Intent(ResumeService.this, Career_counselling.class);
                        startActivity(k);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(ResumeService.this, Jobsandinternships.class);
                        startActivity(l);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent m = new Intent(ResumeService.this, ResumeService.class);
                        startActivity(m);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_learn_english:
                        Intent n = new Intent(ResumeService.this, LearnEnglishPage.class);
                        startActivity(n);
                        dl.closeDrawers();
                        break;
                    default:
...
*/
    ...
    public void onClick(View view) {
        switch (view.getId()) {
                ...
                case R.id.rs_ll_footer_home:
                Intent home = new Intent(ResumeService.this, MainActivity.class);
                startActivity(home);

                break;

                case R.id.rs_ll_footer_callnow:
                CallNowDialog callnow = new CallNowDialog();
                callnow.showDialog(ResumeService.this);

                break;

                case R.id.rs_ll_footer_contactus:
                ContactUsDialog contactUsDialog = new ContactUsDialog();
                contactUsDialog.showDialog(ResumeService.this);
                break;

                case R.id.rs_ll_footer_plans:
                Intent planpage = new Intent(ResumeService.this, MembershipPlanpage.class);
                startActivity(planpage);
                break;

                case R.id.rs_ll_footer_profile:
                Intent profilepage = new Intent(ResumeService.this, ProfilePage.class);
                startActivity(profilepage);

            case R.id.rs_ll_resume_enhancement:
            ...
            case R.id.rs_ll_resume_build:
                Intent resume_bulid = new Intent(ResumeService.this, ResumeBuilder.class);
                startActivity(resume_bulid);
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            String[] strarray_selectsubject = { "Others","Careers","Partners Inquiry"};
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(ResumeService.this,R.layout.my_spinner_items,strarray_selectsubject);
