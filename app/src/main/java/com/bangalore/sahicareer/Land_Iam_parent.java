...
public class Land_Iam_parent extends AppCompatActivity implements View.OnClickListener {
    private DrawerLayout dl;
    private ActionBarDrawerToggle t;
    private NavigationView nv;
    private String TAG = Land_Iam_parent.class.getSimpleName();
    LinearLayout ll_career_assessment,ll_career_counselling,ll_jobs_internships,ll_resume_service,ll_mentorpship,ll_knowledge_centre,ll_school_colleges,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land__iam_parent);
        ...
        ll_footer_home=(LinearLayout)findViewById(R.id.land_f_ll_footer_home);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.land_f_ll_footer_callnow);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.land_f_ll_footer_contactus);
        ll_footer_plans=(LinearLayout)findViewById(R.id.land_f_ll_footer_plans);
        ll_footer_profile=(LinearLayout)findViewById(R.id.land_f_ll_footer_profile);

        ll_career_assessment=(LinearLayout) findViewById(R.id.land_5_ll_ca);
        ll_career_assessment.setOnClickListener(this);

        ll_career_counselling=(LinearLayout) findViewById(R.id.land_5_ll_cc);
        ll_career_counselling.setOnClickListener(this);

        ll_jobs_internships=(LinearLayout) findViewById(R.id.land_5_ll_ji);
        ll_jobs_internships.setOnClickListener(this);

        ll_resume_service=(LinearLayout) findViewById(R.id.land_5_ll_rs);
        ll_resume_service.setOnClickListener(this);

        ll_mentorpship=(LinearLayout) findViewById(R.id.land_5_ll_mentorship);
        ll_mentorpship.setOnClickListener(this);

        ll_knowledge_centre=(LinearLayout) findViewById(R.id.land_5_ll_kc);
        ll_knowledge_centre.setOnClickListener(this);

        ll_school_colleges=(LinearLayout) findViewById(R.id.land_5_ll_sc);
        ll_school_colleges.setOnClickListener(this);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent i = new Intent(Land_Iam_parent.this, MainActivity.class);
                        startActivity(i);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        callnowdialog.showDialog(Land_Iam_parent.this);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
                        view.invalidate();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        contactUsDialog.showDialog(Land_Iam_parent.this);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
                        view.invalidate();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent aboutus = new Intent(Land_Iam_parent.this, MembershipPlanpage.class);
        ...
        ll_footer_profile.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        // Your action here on button click
                        Intent aboutus = new Intent(Land_Iam_parent.this, ProfilePage.class);
                        startActivity(aboutus);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    ...
                    case R.id.nv_item_assessment:
                        Intent j = new Intent(Land_Iam_parent.this, CareerAssessment.class);
                        startActivity(j);
                        break;
                    case R.id.nv_item_counselling:
                        Intent k= new Intent(Land_Iam_parent.this, Career_counselling.class);
                        startActivity(k);
                        break;

                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(Land_Iam_parent.this, Jobsandinternships.class);
                        startActivity(l);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent resume_service = new Intent(Land_Iam_parent.this, ResumeService.class);
                        startActivity(resume_service);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_learn_english:
                        Intent learn_english = new Intent(Land_Iam_parent.this, LearnEnglishPage.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.land_5_ll_ca:

                v.startAnimation(buttonClick);
                Intent assessment = new Intent(Land_Iam_parent.this, CareerAssessment.class);
                startActivity(assessment);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.land_5_ll_cc:

                v.startAnimation(buttonClick);
                Intent counselling = new Intent(Land_Iam_parent.this, Career_counselling.class);
                startActivity(counselling);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;


            case R.id.land_5_ll_ji:

                v.startAnimation(buttonClick);
                Intent jobsandintern = new Intent(Land_Iam_parent.this, Jobsandinternships.class);
                startActivity(jobsandintern);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.land_5_ll_rs:

                v.startAnimation(buttonClick);
                Toast toast1 = Toast.makeText(getApplicationContext(), "This page is Coming Soon", Toast.LENGTH_LONG);
                toast1.setGravity(Gravity.CENTER, 0, 0);
                TextView tv1 = (TextView) toast1.getView().findViewById(android.R.id.message);
            ...
            case R.id.land_5_ll_mentorship:

                v.startAnimation(buttonClick);
                Toast toast2 = Toast.makeText(getApplicationContext(), "This page is Coming Soon", Toast.LENGTH_LONG);
            ...
            case R.id.land_5_ll_kc:

                v.startAnimation(buttonClick);
                Toast toast3 = Toast.makeText(getApplicationContext(), "This page is Coming Soon", Toast.LENGTH_LONG);
                toast3.setGravity(Gravity.CENTER, 0, 0);
                TextView tv3 = (TextView) toast3.getView().findViewById(android.R.id.message);
                tv3.setTextColor(Color.BLACK);
                tv3.setTextSize(14);
                toast3.show();
                break;

            case R.id.land_5_ll_sc:

                v.startAnimation(buttonClick);
                Toast toast4 = Toast.makeText(getApplicationContext(), "This page is Coming Soon", Toast.LENGTH_LONG);
                toast4.setGravity(Gravity.CENTER, 0, 0);
                TextView tv4= (TextView) toast4.getView().findViewById(android.R.id.message);
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(Land_Iam_parent.this,R.layout.my_spinner_items,strarray_selectsubject);
                ...
                public void onClick(View v) {
                    ...
                    if(str_cnt_name.equals("")){
                        ...
                        if (Globalvariables.progressDialog == null) {
                            Globalvariables.progressDialog = Globalvariables.createProgressDialog(Land_Iam_parent.this);
