...
public class Land_10th_11th_class extends AppCompatActivity implements View.OnClickListener {
    private DrawerLayout dl;
    private ActionBarDrawerToggle t;
    private NavigationView nv;
    LinearLayout ll_career_assessment,ll_career_counselling,ll_schools_colleges,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land_10th_11th_class);
        ...
        ll_footer_home=(LinearLayout)findViewById(R.id.land_a_ll_footer_home);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.land_a_ll_footer_callnow);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.land_a_ll_footer_contactus);
        ll_footer_plans=(LinearLayout)findViewById(R.id.land_a_ll_footer_plans);
        ll_footer_profile=(LinearLayout)findViewById(R.id.land_a_ll_footer_profile);

        ll_career_assessment=(LinearLayout) findViewById(R.id.land_ll_9th_10th_ca);
        ll_career_assessment.setOnClickListener(this);

        ll_career_counselling=(LinearLayout) findViewById(R.id.land_ll_9th_10th_cc);
        ll_career_counselling.setOnClickListener(this);

        ll_schools_colleges=(LinearLayout) findViewById(R.id.land_ll_9th_10th_sc);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.nv_item_home:
                        Intent i = new Intent(Land_10th_11th_class.this, MainActivity.class);
                        startActivity(i);
                        break;
                    ...
                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(Land_10th_11th_class.this, Jobsandinternships.class);
                        startActivity(l);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent resume_service = new Intent(Land_10th_11th_class.this, ResumeService.class);
                        startActivity(resume_service);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_learn_english:
                        Intent learn_english = new Intent(Land_10th_11th_class.this, LearnEnglishPage.class);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        Intent aboutus = new Intent(Land_10th_11th_class.this, MainActivity.class);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        callnowdialog.showDialog(Land_10th_11th_class.this);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
                        view.invalidate();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        contactUsDialog.showDialog(Land_10th_11th_class.this);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent aboutus = new Intent(Land_10th_11th_class.this, MembershipPlanpage.class);
                        startActivity(aboutus);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent aboutus = new Intent(Land_10th_11th_class.this, ProfilePage.class);
                        startActivity(aboutus);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.land_ll_9th_10th_ca:

                view.startAnimation(buttonClick);
                Intent assessment = new Intent(Land_10th_11th_class.this, CareerAssessment.class);
                startActivity(assessment);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.land_ll_9th_10th_cc:

                view.startAnimation(buttonClick);
                Intent counselling = new Intent(Land_10th_11th_class.this, Career_counselling.class);
                startActivity(counselling);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;


            case R.id.land_ll_9th_10th_sc:
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(Land_10th_11th_class.this,R.layout.my_spinner_items,strarray_selectsubject);
                    ...
                    if(str_cnt_name.equals("")){
                       ...
                       /* Toast toast = Toast.makeText(getApplicationContext(), ""+str_cnt_name+":"+str_cnt_mobile+":"+str_cnt_email+":"+cnt_selectedsubject+":"+str_cnt_message, Toast.LENGTH_LONG);
                        ...
                        if (Globalvariables.progressDialog == null) {
                            Globalvariables.progressDialog = Globalvariables.createProgressDialog(Land_10th_11th_class.this);
