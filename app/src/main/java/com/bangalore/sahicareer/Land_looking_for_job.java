...
public class Land_looking_for_job extends AppCompatActivity implements View.OnClickListener {
    private DrawerLayout dl;
    private ActionBarDrawerToggle t;
    private NavigationView nv;
    private String TAG = Land_iam_working_professional.class.getSimpleName();
    LinearLayout ll_career_assessment,ll_career_counselling,ll_jobs_internships,ll_resume_service,ll_mentorpship,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land_looking_for_job);
        ...
        ll_footer_home=(LinearLayout)findViewById(R.id.land_d_ll_footer_home);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.land_d_ll_footer_callnow);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.land_d_ll_footer_contactus);
        ll_footer_plans=(LinearLayout)findViewById(R.id.land_d_ll_footer_plans);
        ll_footer_profile=(LinearLayout)findViewById(R.id.land_d_ll_footer_profile);

        ll_career_assessment=(LinearLayout) findViewById(R.id.land_3_ll_ca);
        ll_career_assessment.setOnClickListener(this);

        ll_career_counselling=(LinearLayout) findViewById(R.id.land_3_ll_cc);
        ll_career_counselling.setOnClickListener(this);

        ll_jobs_internships=(LinearLayout) findViewById(R.id.land_3_ll_ji);
        ll_jobs_internships.setOnClickListener(this);

        ll_resume_service=(LinearLayout) findViewById(R.id.land_3_ll_rs);
        ll_resume_service.setOnClickListener(this);

        ll_mentorpship=(LinearLayout) findViewById(R.id.land_3_ll_mentorship);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent i = new Intent(Land_looking_for_job.this, MainActivity.class);
                        startActivity(i);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        callnowdialog.showDialog(Land_looking_for_job.this);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
                        view.invalidate();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        contactUsDialog.showDialog(Land_looking_for_job.this);
                    case MotionEvent.ACTION_CANCEL: {
                        LinearLayout view = (LinearLayout) v;
                        view.getBackground().clearColorFilter();
                        view.invalidate();
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        Intent aboutus = new Intent(Land_looking_for_job.this, MembershipPlanpage.class);
        ...
        ll_footer_profile.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        // Your action here on button click
                        Intent aboutus = new Intent(Land_looking_for_job.this, ProfilePage.class);
                        startActivity(aboutus);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    ...
                    case R.id.nv_item_assessment:
                        Intent j = new Intent(Land_looking_for_job.this, CareerAssessment.class);
                        startActivity(j);
                        break;
                    case R.id.nv_item_counselling:
                        Intent k= new Intent(Land_looking_for_job.this, Career_counselling.class);
                        startActivity(k);
                        break;
                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(Land_looking_for_job.this, Jobsandinternships.class);
                        startActivity(l);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent resume_service = new Intent(Land_looking_for_job.this, ResumeService.class);
                        startActivity(resume_service);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_learn_english:
                        Intent learn_english = new Intent(Land_looking_for_job.this, LearnEnglishPage.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.land_3_ll_ca:

                v.startAnimation(buttonClick);
                Intent assessment = new Intent(Land_looking_for_job.this, CareerAssessment.class);
                startActivity(assessment);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.land_3_ll_cc:

                v.startAnimation(buttonClick);
                Intent counselling = new Intent(Land_looking_for_job.this, Career_counselling.class);
                startActivity(counselling);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;


            case R.id.land_3_ll_ji:

                v.startAnimation(buttonClick);
                Intent jobsandintern = new Intent(Land_looking_for_job.this, Jobsandinternships.class);
                startActivity(jobsandintern);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.land_3_ll_rs:
            ...
            case R.id.land_3_ll_mentorship:
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(Land_looking_for_job.this,R.layout.my_spinner_items,strarray_selectsubject);
                ...
                public void onClick(View v) {
                    ...
                    if(str_cnt_name.equals("")){
                        ...
                        if (Globalvariables.progressDialog == null) {
                            Globalvariables.progressDialog = Globalvariables.createProgressDialog(Land_looking_for_job.this);
