...
public class Represent_college extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG = Represent_college.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_represent_college);
        ...
        ll_ca=(LinearLayout) findViewById(R.id.represent_college_ll_ca);
        ll_ca.setOnClickListener(this);

        ll_cc=(LinearLayout) findViewById(R.id.represent_college_ll_cc);
        ll_cc.setOnClickListener(this);

        ll_ji=(LinearLayout) findViewById(R.id.represent_college_ll_ji);
        ll_ji.setOnClickListener(this);

        ll_rs=(LinearLayout) findViewById(R.id.represent_college_ll_rs);
        ll_rs.setOnClickListener(this);

        ll_kc=(LinearLayout) findViewById(R.id.represent_college_ll_kc);
        ll_kc.setOnClickListener(this);


        ll_footer_home=(LinearLayout)findViewById(R.id.represent_college_ll_footer_home);
        ll_footer_home.setOnClickListener(this);
        ll_footer_callnow=(LinearLayout)findViewById(R.id.represent_college_ll_footer_callnow);
        ll_footer_callnow.setOnClickListener(this);
        ll_footer_contactus=(LinearLayout)findViewById(R.id.represent_college_ll_footer_contactus);
        ll_footer_contactus.setOnClickListener(this);
        ll_footer_plans=(LinearLayout)findViewById(R.id.represent_college_ll_footer_plans);
        ll_footer_plans.setOnClickListener(this);
        ll_footer_profile=(LinearLayout)findViewById(R.id.represent_college_ll_footer_profile);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.nv_item_home:
                        Intent i = new Intent(Represent_college.this, MainActivity.class);
                        startActivity(i);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_assessment:
                        Intent j = new Intent(Represent_college.this, CareerAssessment.class);
                        startActivity(j);
                        dl.closeDrawers();
                        break;
                    case R.id.nv_item_counselling:
                        Intent k= new Intent(Represent_college.this, Career_counselling.class);
                        startActivity(k);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_jobs_internships:
                        Intent l = new Intent(Represent_college.this, Jobsandinternships.class);
                        startActivity(l);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_Resume_Service:
                        Intent resume_service = new Intent(Represent_college.this, ResumeService.class);
                        startActivity(resume_service);
                        dl.closeDrawers();
                        break;

                    case R.id.nv_item_learn_english:
                        Intent learn_english = new Intent(Represent_college.this, LearnEnglishPage.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.represent_college_ll_footer_home:
                Intent home = new Intent(Represent_college.this, MainActivity.class);
                startActivity(home);

                break;

            case R.id.represent_college_ll_footer_callnow:
                CallNowDialog callnowdialog = new CallNowDialog();
                callnowdialog.showDialog(Represent_college.this);
                break;

            case R.id.represent_college_ll_footer_contactus:
                ContactUsDialog contactUsDialog = new ContactUsDialog();
                contactUsDialog.showDialog(Represent_college.this);

                break;

            case R.id.represent_college_ll_footer_plans:
                Intent planpage = new Intent(Represent_college.this, MembershipPlanpage.class);
                startActivity(planpage);

                break;


            case R.id.represent_college_ll_footer_profile:
                Intent profilepage = new Intent(Represent_college.this, ProfilePage.class);
                startActivity(profilepage);

                break;

            case R.id.represent_college_ll_ca:

                v.startAnimation(buttonClick);
                Intent assessment = new Intent(Represent_college.this, CareerAssessment.class);
                startActivity(assessment);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.represent_college_ll_cc:

                v.startAnimation(buttonClick);
                Intent counselling = new Intent(Represent_college.this, Career_counselling.class);
                startActivity(counselling);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.represent_college_ll_ji:

                v.startAnimation(buttonClick);
                Intent jobsandintern = new Intent(Represent_college.this, Jobsandinternships.class);
                startActivity(jobsandintern);
                overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                break;

            case R.id.represent_college_ll_rs:

                v.startAnimation(buttonClick);
                Intent resumeservice = new Intent(Represent_college.this, ResumeService.class);
    ...
    public class ContactUsDialog {
        ...
        public void showDialog(Activity activity) {
            ...
            adapterLanguage =    new ArrayAdapter<CharSequence>(Represent_college.this,R.layout.my_spinner_items,strarray_selectsubject);
                ...
                public void onClick(View v) {
                    ...
                    if(str_cnt_name.equals("")){
                        ...
                        if (Globalvariables.progressDialog == null) {
                            Globalvariables.progressDialog = Globalvariables.createProgressDialog(Represent_college.this);
